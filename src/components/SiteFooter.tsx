        ...
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-bone/60">
              <li className="flex gap-2"><MapPin className="w-4 h-4 mt-0.5 text-gold" /> Αθήνα, Ελλάδα</li>
              <li className="flex gap-2"><Phone className="w-4 h-4 mt-0.5 text-gold" /> +30 210 000 0000</li>
              <li className="flex gap-2"><Mail className="w-4 h-4 mt-0.5 text-gold" /> info@dsscalp.gr</li>
