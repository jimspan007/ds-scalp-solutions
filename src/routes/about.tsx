  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Το DS Scalp Micropigmentation καθοδηγείται από τον Σπανούδη Δημήτρη, πιστοποιημένο SMP artist με πολυετή εμπειρία στο χώρο του Scalp Micropigmentation."
      />
