...
const services = [
  {
    n: "01",
    title: "Αποκατάσταση hairline",
    body: "",
    bullets: ["Προσωποποιημένος σχεδιασμός γραμμής", "Φυσική απαλότητα", "3 συνεδρίες"],
  },
  {
    n: "02",
  ...
  },
  {
    ...
    bullets: ["Ολική μεταμόρφωση", "Συμμετρία & έλεγχος σκίασης", "3 συνεδρίες","Απόλυτα φυσικό hairline"],
  },
  {
    n: "04",
    title: "Κάλυψη Ουλών",
  ...
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Υπηρεσίες"
        title=""
        intro="Το Scalp micropigmentation είναι μια εξειδικευμένη, μη επεμβατική τεχνική που δημιουργεί την όψη φυσικών θυλάκων τρίχας."
      />
